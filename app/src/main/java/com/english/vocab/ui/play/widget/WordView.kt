...
import com.english.vocab.databinding.LayoutWordViewBinding
...
class WordView
    ...
    constructor(
        ...
        init {
            ...
            typedArray.recycle()
            adapter =
                LetterAdapter(if (type == "1") TypeLetter.TYPE_QUESTION else TypeLetter.TYPE_ANSWER)
            adapter.listener =
                object : BaseListAdapter.Action<Letter> {
                    override fun click(
                        position: Int,
                        data: Letter,
                        code: Int,
